package io.openkruise.agents.client.v2.models.sandboxtemplatespec.autopausepolicy;
...
public class Resume implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.openkruise.agents.client.v2.models.sandboxtemplatespec.autopausepolicy.resume.OnIngressTraffic onIngressTraffic;

    public io.openkruise.agents.client.v2.models.sandboxtemplatespec.autopausepolicy.resume.OnIngressTraffic getOnIngressTraffic() {
        return onIngressTraffic;
    }

    public void setOnIngressTraffic(io.openkruise.agents.client.v2.models.sandboxtemplatespec.autopausepolicy.resume.OnIngressTraffic onIngressTraffic) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.openkruise.agents.client.v2.models.sandboxtemplatespec.autopausepolicy.resume.WhenProbedScheduleTime whenProbedScheduleTime;

    public io.openkruise.agents.client.v2.models.sandboxtemplatespec.autopausepolicy.resume.WhenProbedScheduleTime getWhenProbedScheduleTime() {
        return whenProbedScheduleTime;
    }

    public void setWhenProbedScheduleTime(io.openkruise.agents.client.v2.models.sandboxtemplatespec.autopausepolicy.resume.WhenProbedScheduleTime whenProbedScheduleTime) {
