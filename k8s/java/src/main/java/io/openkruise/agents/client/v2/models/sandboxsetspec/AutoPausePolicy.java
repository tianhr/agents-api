...
public class AutoPausePolicy implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.openkruise.agents.client.v2.models.sandboxsetspec.autopausepolicy.Pause pause;

    public io.openkruise.agents.client.v2.models.sandboxsetspec.autopausepolicy.Pause getPause() {
        return pause;
    }

    public void setPause(io.openkruise.agents.client.v2.models.sandboxsetspec.autopausepolicy.Pause pause) {
        this.pause = pause;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.openkruise.agents.client.v2.models.sandboxsetspec.autopausepolicy.Resume resume;

    public io.openkruise.agents.client.v2.models.sandboxsetspec.autopausepolicy.Resume getResume() {
        return resume;
    }

    public void setResume(io.openkruise.agents.client.v2.models.sandboxsetspec.autopausepolicy.Resume resume) {
        this.resume = resume;
    }
}
