...
public class Pause implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.openkruise.agents.client.v2.models.sandboxtemplatespec.autopausepolicy.pause.WhenProbedIdleState whenProbedIdleState;

    public io.openkruise.agents.client.v2.models.sandboxtemplatespec.autopausepolicy.pause.WhenProbedIdleState getWhenProbedIdleState() {
        return whenProbedIdleState;
    }

    public void setWhenProbedIdleState(io.openkruise.agents.client.v2.models.sandboxtemplatespec.autopausepolicy.pause.WhenProbedIdleState whenProbedIdleState) {
