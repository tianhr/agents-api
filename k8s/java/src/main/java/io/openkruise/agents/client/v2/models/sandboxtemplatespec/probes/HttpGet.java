package io.openkruise.agents.client.v2.models.sandboxtemplatespec.probes;
...
public class HttpGet implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.openkruise.agents.client.v2.models.sandboxtemplatespec.probes.httpget.HttpHeaders> httpHeaders;

    public java.util.List<io.openkruise.agents.client.v2.models.sandboxtemplatespec.probes.httpget.HttpHeaders> getHttpHeaders() {
        return httpHeaders;
    }

    public void setHttpHeaders(java.util.List<io.openkruise.agents.client.v2.models.sandboxtemplatespec.probes.httpget.HttpHeaders> httpHeaders) {
