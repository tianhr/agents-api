...
public class Probes implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.openkruise.agents.client.v2.models.sandboxspec.probes.Exec exec;

    public io.openkruise.agents.client.v2.models.sandboxspec.probes.Exec getExec() {
        return exec;
    }

    public void setExec(io.openkruise.agents.client.v2.models.sandboxspec.probes.Exec exec) {
        this.exec = exec;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.openkruise.agents.client.v2.models.sandboxspec.probes.Grpc grpc;

    public io.openkruise.agents.client.v2.models.sandboxspec.probes.Grpc getGrpc() {
        return grpc;
    }

    public void setGrpc(io.openkruise.agents.client.v2.models.sandboxspec.probes.Grpc grpc) {
        this.grpc = grpc;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.openkruise.agents.client.v2.models.sandboxspec.probes.HttpGet httpGet;

    public io.openkruise.agents.client.v2.models.sandboxspec.probes.HttpGet getHttpGet() {
        return httpGet;
    }

    public void setHttpGet(io.openkruise.agents.client.v2.models.sandboxspec.probes.HttpGet httpGet) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.openkruise.agents.client.v2.models.sandboxspec.probes.TcpSocket tcpSocket;

    public io.openkruise.agents.client.v2.models.sandboxspec.probes.TcpSocket getTcpSocket() {
        return tcpSocket;
    }

    public void setTcpSocket(io.openkruise.agents.client.v2.models.sandboxspec.probes.TcpSocket tcpSocket) {
